...
import (
	...
	"database/sql"
	"errors"
	v12 "github.com/jamalkaksouri/todoapp-golang-microservice/pkg/api/v1"
...
func Test_toDoServiceServer_Create(t *testing.T) {
	...
	type args struct {
		ctx context.Context
		req *v12.CreateRequest
	}
	tests := []struct {
		name    string
		s       v12.ToDoServiceServer
		args    args
		mock    func()
		want    *v12.CreateResponse
		wantErr bool
	}{
		{
			name: "OK",
